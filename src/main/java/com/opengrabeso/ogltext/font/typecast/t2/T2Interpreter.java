...
package com.opengrabeso.ogltext.font.typecast.t2;

import java.util.ArrayList;

import com.opengrabeso.ogltext.font.typecast.ot.Point;
import com.opengrabeso.ogltext.font.typecast.ot.table.CharstringType2;
...
public class T2Interpreter {
    ...
    private ArrayList<com.opengrabeso.ogltext.font.typecast.ot.Point> _points;
    ...
    private void _rmoveto() {
        ...
        clearArg();
        final com.opengrabeso.ogltext.font.typecast.ot.Point lastPoint = getLastPoint();
    ...
    public com.opengrabeso.ogltext.font.typecast.ot.Point[] execute(final CharstringType2 cs) {
        _points = new ArrayList<com.opengrabeso.ogltext.font.typecast.ot.Point>();
        cs.resetIP();
        while (cs.moreBytes()) {
            ...
            if (operator == 12) {
                ...
                // Two-byte operators
                switch (operator) {
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.AND:
                    _and();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.OR:
                    _or();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.NOT:
                    _not();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.ABS:
                    _abs();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.ADD:
                    _add();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.SUB:
                    _sub();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.DIV:
                    _div();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.NEG:
                    _neg();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.EQ:
                    _eq();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.DROP:
                    _drop();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.PUT:
                    _put();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.GET:
                    _get();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.IFELSE:
                    _ifelse();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.RANDOM:
                    _random();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.MUL:
                    _mul();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.SQRT:
                    _sqrt();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.DUP:
                    _dup();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.EXCH:
                    _exch();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.INDEX:
                    _index();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.ROLL:
                    _roll();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.HFLEX:
                    _hflex();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.FLEX:
                    _flex();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.HFLEX1:
                    _hflex1();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.FLEX1:
                    _flex1();
                    break;
                default:
                    //throw new Exception();
                ...
                // One-byte operators
                switch (operator) {
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.HSTEM:
                    _hstem();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.VSTEM:
                    _vstem();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.VMOVETO:
                    _vmoveto();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.RLINETO:
                    _rlineto();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.HLINETO:
                    _hlineto();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.VLINETO:
                    _vlineto();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.RRCURVETO:
                    _rrcurveto();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.CALLSUBR:
                    _callsubr();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.RETURN:
                    _return();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.ENDCHAR:
                    _endchar();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.HSTEMHM:
                    _hstemhm();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.HINTMASK:
                    _hintmask();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.CNTRMASK:
                    _cntrmask();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.RMOVETO:
                    _rmoveto();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.HMOVETO:
                    _hmoveto();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.VSTEMHM:
                    _vstemhm();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.RCURVELINE:
                    _rcurveline();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.RLINECURVE:
                    _rlinecurve();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.VVCURVETO:
                    _vvcurveto();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.HHCURVETO:
                    _hhcurveto();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.CALLGSUBR:
                    _callgsubr();
                    break;
                case com.opengrabeso.ogltext.font.typecast.t2.T2Mnemonic.VHCURVETO:
                    _vhcurveto();
                    break;
        ...
        final com.opengrabeso.ogltext.font.typecast.ot.Point[] pointArray = new com.opengrabeso.ogltext.font.typecast.ot.Point[_points.size()];
    ...
    private com.opengrabeso.ogltext.font.typecast.ot.Point getLastPoint() {
        final int size = _points.size();
        if (size > 0) {
            return _points.get(size - 1);
        } else {
            return new com.opengrabeso.ogltext.font.typecast.ot.Point(0, 0, true, false);
        }
    }

    private void moveTo(final int x, final int y) {
        endContour();
        _points.add(new com.opengrabeso.ogltext.font.typecast.ot.Point(x, y, true, false));
    }
    ...
    private void curveTo(final int cx1, final int cy1, final int cx2, final int cy2, final int x, final int y) {
        _points.add(new com.opengrabeso.ogltext.font.typecast.ot.Point(cx1, cy1, false, false));
        _points.add(new com.opengrabeso.ogltext.font.typecast.ot.Point(cx2, cy2, false, false));
        _points.add(new com.opengrabeso.ogltext.font.typecast.ot.Point(x, y, true, false));
    }
