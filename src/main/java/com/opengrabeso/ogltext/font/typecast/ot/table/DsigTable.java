...
public class DsigTable implements Table {
    ...
    private final com.opengrabeso.ogltext.font.typecast.ot.table.DsigEntry[] dsigEntry;
    private final com.opengrabeso.ogltext.font.typecast.ot.table.SignatureBlock[] sigBlocks;

    /** Creates new DsigTable */
    protected DsigTable(final com.opengrabeso.ogltext.font.typecast.ot.table.DirectoryEntry de, final DataInput di) throws IOException {
        ...
        dsigEntry = new com.opengrabeso.ogltext.font.typecast.ot.table.DsigEntry[numSigs];
        sigBlocks = new com.opengrabeso.ogltext.font.typecast.ot.table.SignatureBlock[numSigs];
