...
package com.opengrabeso.ogltext.font.typecast.tt.engine;

import com.opengrabeso.ogltext.font.typecast.ot.Mnemonic;
import com.opengrabeso.ogltext.font.typecast.ot.Point;
...
public class Interpreter {
    ...
    private com.opengrabeso.ogltext.font.typecast.tt.engine.Parser parser = null;
    private final GraphicsState gs = new GraphicsState();
    private final com.opengrabeso.ogltext.font.typecast.ot.Point[][] zone = new com.opengrabeso.ogltext.font.typecast.ot.Point[2][];
    ...
    public Interpreter(final int stackMax, final int storeMax, final int funcMax) {
        zone[0] = new com.opengrabeso.ogltext.font.typecast.ot.Point[256];
        zone[1] = new com.opengrabeso.ogltext.font.typecast.ot.Point[256];
    ...
    public void execute(int ip) {
        while (ip < ((ip & 0xffff0000) | parser.getISLength(ip >> 16))) {
            ...
            if (inFuncDef) {
                ...
                if (opcode == com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.ENDF) {
                    inFuncDef = false;
                }
                ip = parser.advanceIP(ip);
                continue;
            }
            if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.MIRP) _mirp((short)(opcode & 31));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.MDRP) _mdrp((short)(opcode & 31));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.PUSHW) _push(parser.getPushData(ip));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.PUSHB) _push(parser.getPushData(ip));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.INSTCTRL) _instctrl();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SCANTYPE) _scantype();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.MIN) _min();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.MAX) _max();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.ROLL) _roll();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.IDEF) _idef();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.GETINFO) _getinfo();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SDPVTL) _sdpvtl((short)(opcode & 1));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SCANCTRL) _scanctrl();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.FLIPRGOFF) _fliprgoff();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.FLIPRGON) _fliprgon();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.FLIPPT) _flippt();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.AA); // AA (ignored)
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SANGW); // SANGW (ignored)
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.RDTG) _rdtg();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.RUTG) _rutg();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.ROFF) _roff();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.JROF) ip = _jrof(ip);
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.JROT) ip = _jrot(ip);
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.S45ROUND) _s45round();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SROUND) _sround();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.DELTAC3) _deltac3();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.DELTAC2) _deltac2();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.DELTAC1) _deltac1();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.DELTAP3) _deltap3();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.DELTAP2) _deltap2();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.WCVTF) _wcvtf();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.NROUND) _nround((short)(opcode & 3));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.ROUND) _round((short)(opcode & 3));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.CEILING) _ceiling();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.FLOOR) _floor();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.NEG) _neg();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.ABS) _abs();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.MUL) _mul();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.DIV) _div();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SUB) _sub();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.ADD) _add();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SDS) _sds();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SDB) _sdb();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.DELTAP1) _deltap1();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.NOT) _not();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.OR) _or();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.AND) _and();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.EIF); // EIF
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.IF) ip = _if(ip);
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.EVEN) _even();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.ODD) _odd();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.NEQ) _neq();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.EQ) _eq();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.GTEQ) _gteq();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.GT) _gt();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.LTEQ) _lteq();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.LT) _lt();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.DEBUG) _debug();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.FLIPOFF) _flipoff();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.FLIPON) _flipon();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.MPS) _mps();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.MPPEM) _mppem();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.MD) _md((short)(opcode & 1));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SCFS) _scfs();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.GC) _gc((short)(opcode & 1));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.RCVT) _rcvt();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.WCVTP) _wcvtp();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.RS) _rs();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.WS) _ws();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.NPUSHW) _push(parser.getPushData(ip));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.NPUSHB) _push(parser.getPushData(ip));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.MIAP) _miap((short)(opcode & 1));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.RTDG) _rtdg();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.ALIGNRP) _alignrp();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.IP) _ip();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.MSIRP) _msirp((short)(opcode & 1));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SHPIX) _shpix();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SHZ) _shz((short)(opcode & 1));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SHC) _shc((short)(opcode & 1));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SHP) _shp((short)(opcode & 1));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.IUP) _iup((short)(opcode & 1));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.MDAP) _mdap((short)(opcode & 1));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.ENDF) return;
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.FDEF) _fdef(ip + 1);
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.CALL) _call();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.LOOPCALL) _loopcall();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.UTP) _utp();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.ALIGNPTS) _alignpts();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.MINDEX) _mindex();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.CINDEX) _cindex();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.DEPTH) _depth();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SWAP) _swap();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.CLEAR) _clear();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.POP) pop();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.DUP) _dup();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SSW) _ssw();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SSWCI) _sswci();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SCVTCI) _scvtci();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.JMPR) ip = _jmpr(ip);
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.ELSE) ip = _else(ip);
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SMD) _smd();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.RTHG) _rthg();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.RTG) _rtg();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SLOOP) _sloop();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SZPS) _szps();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SZP2) _szp2();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SZP1) _szp1();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SZP0) _szp0();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SRP2) _srp2();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SRP1) _srp1();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SRP0) _srp0();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.ISECT) _isect();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SFVTPV) _sfvtpv();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.GFV) _gfv();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.GPV) _gpv();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SFVFS) _sfvfs();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SPVFS) _spvfs();
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SFVTL) _sfvtl((short)(opcode & 1));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SPVTL) _spvtl((short)(opcode & 1));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SFVTCA) _sfvtca((short)(opcode & 1));
            else if (opcode >= com.opengrabeso.ogltext.font.typecast.ot.Mnemonic.SPVTCA) _spvtca((short)(opcode & 1));
