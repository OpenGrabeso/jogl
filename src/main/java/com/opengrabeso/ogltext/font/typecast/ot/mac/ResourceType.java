...
package com.opengrabeso.ogltext.font.typecast.ot.mac;
...
public class ResourceType {
    ...
    private final com.opengrabeso.ogltext.font.typecast.ot.mac.ResourceReference[] references;
    ...
    protected ResourceType(final DataInput di) throws IOException {
        ...
        references = new com.opengrabeso.ogltext.font.typecast.ot.mac.ResourceReference[count];
    }

    protected void readRefs(final DataInput di) throws IOException {
        for (int i = 0; i < count; i++) {
            references[i] = new com.opengrabeso.ogltext.font.typecast.ot.mac.ResourceReference(di);
        }
    }
