...
public class ClassDefFormat2 extends ClassDef {
    ...
    private final com.opengrabeso.ogltext.font.typecast.ot.table.RangeRecord[] classRangeRecords;
    ...
    public ClassDefFormat2(final RandomAccessFile raf) throws IOException {
        ...
        classRangeRecords = new com.opengrabeso.ogltext.font.typecast.ot.table.RangeRecord[classRangeCount];
