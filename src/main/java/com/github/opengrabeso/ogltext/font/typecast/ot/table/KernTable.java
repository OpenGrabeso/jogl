...
public class KernTable implements Table {
    ...
    private final com.github.opengrabeso.ogltext.font.typecast.ot.table.KernSubtable[] tables;

    /** Creates new KernTable */
    protected KernTable(final com.github.opengrabeso.ogltext.font.typecast.ot.table.DirectoryEntry de, final DataInput di) throws IOException {
        ...
        tables = new com.github.opengrabeso.ogltext.font.typecast.ot.table.KernSubtable[nTables];
        for (int i = 0; i < nTables; i++) {
            tables[i] = com.github.opengrabeso.ogltext.font.typecast.ot.table.KernSubtable.read(di);
        }
    }
