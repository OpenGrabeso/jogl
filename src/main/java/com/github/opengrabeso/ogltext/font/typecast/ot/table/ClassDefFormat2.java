...
public class ClassDefFormat2 extends ClassDef {
    ...
    private final com.github.opengrabeso.ogltext.font.typecast.ot.table.RangeRecord[] classRangeRecords;
    ...
    public ClassDefFormat2(final RandomAccessFile raf) throws IOException {
        ...
        classRangeRecords = new com.github.opengrabeso.ogltext.font.typecast.ot.table.RangeRecord[classRangeCount];
