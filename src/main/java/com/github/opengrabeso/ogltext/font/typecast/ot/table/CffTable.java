...
public class CffTable implements Table {
    ...
    private final com.github.opengrabeso.ogltext.font.typecast.ot.table.Charstring[][] _charstringsArray;

    private final byte[] _buf;

    /** Creates a new instance of CffTable */
    protected CffTable(final com.github.opengrabeso.ogltext.font.typecast.ot.table.DirectoryEntry de, final DataInput di) throws IOException {
        ...
        _charstringsArray = new com.github.opengrabeso.ogltext.font.typecast.ot.table.Charstring[_topDictIndex.getCount()][];
        for (int i = 0; i < _topDictIndex.getCount(); ++i) {
            ...
            _charstringsArray[i] = new com.github.opengrabeso.ogltext.font.typecast.ot.table.Charstring[glyphCount];
