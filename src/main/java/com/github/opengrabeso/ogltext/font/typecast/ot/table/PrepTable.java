...
import com.github.opengrabeso.ogltext.font.typecast.ot.Disassembler;
...
public class PrepTable extends Program implements Table {
    ...
    public PrepTable(final com.github.opengrabeso.ogltext.font.typecast.ot.table.DirectoryEntry de, final DataInput di) throws IOException {
