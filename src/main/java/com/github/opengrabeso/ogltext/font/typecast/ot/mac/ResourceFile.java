...
public class ResourceFile {
    ...
    private final com.github.opengrabeso.ogltext.font.typecast.ot.mac.ResourceMap map;
    ...
    public ResourceFile(final RandomAccessFile raf) throws IOException {
        ...
        map = new com.github.opengrabeso.ogltext.font.typecast.ot.mac.ResourceMap(raf);
    }
